  ...
  <div class="panel">
    ...
    <table class="rank-table">
      ...
      <tr>
        ...
        <td><a class="pname" style="display:flex; align-items:center; gap:8px;" href="/player?sid={{ r.sid }}&numqbs={{ 2 if fmt=='superflex' else 1 }}&ref={{ ('/rankings?format=' ~ fmt)|urlencode }}"><img src="{{ r.photo }}" alt="" loading="lazy" onerror="this.style.visibility='hidden'">{{ r.name }}</a></td>
