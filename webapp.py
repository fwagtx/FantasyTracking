...
def leagues_page():
    ...
    if username:
        try:
            ...
            error = str(e)
    return render_template_string(HOME_HTML, username=username, data=data, error=error, portfolio=portfolio, fmt=fmt)
...
(function(){
  ...
  function applyFilter(){
    ...
    document.querySelectorAll('#expoTable .expo-row').forEach(function(row){
