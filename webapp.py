...
def rankings():
    ...
    for sid, v in fc_players.items():
        ...
        if overall_rank <= 4:
            ...
            tier = "C"
        elif position == "QB" and position_rank <= 32:
            # A top-32 QB is a real starter (roughly one per NFL team) even
            # if dynasty value alone would've dropped them further down
            # the overall list -- that's a QB-scarcity quirk, not a sign
